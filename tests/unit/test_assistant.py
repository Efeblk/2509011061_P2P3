...
async def test_extract_filters_valid(mock_ai_client):
    ...
    # Mock AI response
    assistant.reasoning_client.generate_json.return_value = {
        "max_price": 500,
        "city": "Istanbul",
        "date_range": None
    }
...
async def test_search_hybrid(mock_ai_client, mock_db):
    ...
    assistant.extract_filters = AsyncMock(return_value={
        "max_price": 500,
        "city": "Istanbul"
    })
...
async def test_generate_answer(mock_ai_client, mock_db):
    ...
    # Mock Event Details
    assistant._fetch_event_details = AsyncMock(return_value={
        "title": "Event 1",
        "venue": "Venue 1",
        "date": "2025-01-01",
        "price": 100
